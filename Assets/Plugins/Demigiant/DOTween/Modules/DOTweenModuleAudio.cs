...
namespace Plugins.Demigiant.DOTween.Modules
{
	public static class DOTweenModuleAudio
	{
		...
		{
			return DG.Tweening.DOTween.Complete(
				target,
				withCallbacks
			);
		}
		...
		{
			return DG.Tweening.DOTween.Kill(
				target,
				complete
			);
		}
		...
		{
			return DG.Tweening.DOTween.Flip(
				target
			);
		}
		...
		{
			return DG.Tweening.DOTween.Goto(
				target,
				to,
				andPlay
			);
		...
		{
			return DG.Tweening.DOTween.Pause(
				target
			);
		}
		...
		{
			return DG.Tweening.DOTween.Play(
				target
			);
		}
		...
		{
			return DG.Tweening.DOTween.PlayBackwards(
				target
			);
		}
		...
		{
			return DG.Tweening.DOTween.PlayForward(
				target
			);
		}
		...
		{
			return DG.Tweening.DOTween.Restart(
				target
			);
		}
		...
		{
			return DG.Tweening.DOTween.Rewind(
				target
			);
		}
		...
		{
			return DG.Tweening.DOTween.SmoothRewind(
				target
			);
		}
		...
		{
			return DG.Tweening.DOTween.TogglePause(
				target
			);
		}
