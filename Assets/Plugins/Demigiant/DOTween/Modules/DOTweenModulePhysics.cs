...
namespace Plugins.Demigiant.DOTween.Modules
{
	public static class DOTweenModulePhysics
	{
		...
		{
			TweenerCore<Vector3, Vector3, VectorOptions> t = DG.Tweening.DOTween.To(
				() => target.position,
				target.MovePosition,
				endValue,
				duration
		...
		{
			TweenerCore<Quaternion, Vector3, QuaternionOptions> t = DG.Tweening.DOTween.To(
				() => target.rotation,
				target.MoveRotation,
				endValue,
				duration
		...
		{
			TweenerCore<Quaternion, Vector3, QuaternionOptions> t = DG.Tweening.DOTween
				.To(
					() => target.rotation,
					target.MoveRotation,
					towards,
		...
		)
		{
			...
			Tween yTween = DG.Tweening.DOTween.To(
					() => target.position,
					target.MovePosition,
					new Vector3(
						0,
			...
			s.Append(
				...
				.SetTarget(
					...
					DG.Tweening.DOTween.defaultEaseType
				);
			yTween.OnUpdate(
				() =>
				{
		...
		)
		{
			...
			TweenerCore<Vector3, Path, PathOptions> t = DG.Tweening.DOTween.To(
					PathPlugin.Get(),
					() => target.position,
					target.MovePosition,
					new Path(
		...
		{
			TweenerCore<Vector3, Path, PathOptions> t = DG.Tweening.DOTween
				.To(
					PathPlugin.Get(),
					() => target.position,
					target.MovePosition,
