...
namespace DG.Tweening
{
	...
	public static class DOTweenModuleUnityVersion
	{
		...
		public static CustomYieldInstruction WaitForCompletion(this Tween t, bool returnCustomYieldInstruction)
		{
			if (!t.active)
			{
				if (Debugger.logPriority > 0)
					Debugger.LogInvalidTween(
						t
					);
				return null;
			}

			return new DOTweenCYInstruction.WaitForCompletion(
				t
			);
		}
		...
		public static CustomYieldInstruction WaitForRewind(this Tween t, bool returnCustomYieldInstruction)
		{
			...
			return new DOTweenCYInstruction.WaitForRewind(
				t
			);
		}
		...
		public static CustomYieldInstruction WaitForKill(this Tween t, bool returnCustomYieldInstruction)
		{
			...
			return new DOTweenCYInstruction.WaitForKill(
				t
			);
		}
		...
		)
		{
			...
			return new DOTweenCYInstruction.WaitForPosition(
				t,
				position
			);
		}
		...
		public static CustomYieldInstruction WaitForStart(this Tween t, bool returnCustomYieldInstruction)
		{
			...
			return new DOTweenCYInstruction.WaitForStart(
				t
			);
		}
		...
		)
		{
			...
			{
				if (Debugger.logPriority > 0)
					Debugger.LogMissingMaterialProperty(
						propertyID
					);
				return null;
			}

			TweenerCore<Vector2, Vector2, VectorOptions> t = DG.Tweening.DOTween.To(
				() => target.GetTextureOffset(
					propertyID
				),
				x => target.SetTextureOffset(
					propertyID,
					x
				),
				endValue,
		...
		)
		{
			...
			TweenerCore<Vector2, Vector2, VectorOptions> t = DG.Tweening.DOTween.To(
				() => target.GetTextureScale(
					propertyID
				),
				x => target.SetTextureScale(
					propertyID,
					x
				),
				endValue,
		...
		/// </summary>
		public async static Task AsyncWaitForCompletion(this Tween t)
		{
			if (!t.active)
			{
				if (Debugger.logPriority > 0)
		...
		/// </summary>
		public async static Task AsyncWaitForRewind(this Tween t)
		{
			if (!t.active)
			{
				if (Debugger.logPriority > 0)
		...
		/// </summary>
		public async static Task AsyncWaitForKill(this Tween t)
		{
			if (!t.active)
			{
				if (Debugger.logPriority > 0)
		...
		/// </summary>
		/// <param name="elapsedLoops">Elapsed loops to wait for</param>
		public async static Task AsyncWaitForElapsedLoops(this Tween t, int elapsedLoops)
		{
			if (!t.active)
			{
				if (Debugger.logPriority > 0)
		...
		/// </summary>
		/// <param name="position">Position (loops included, delays excluded) to wait for</param>
		public async static Task AsyncWaitForPosition(this Tween t, float position)
		{
			if (!t.active)
			{
				if (Debugger.logPriority > 0)
		...
		///     <code>await myTween.AsyncWaitForKill();</code>
		/// </summary>
		public async static Task AsyncWaitForStart(this Tween t)
		{
			if (!t.active)
			{
				if (Debugger.logPriority > 0)
