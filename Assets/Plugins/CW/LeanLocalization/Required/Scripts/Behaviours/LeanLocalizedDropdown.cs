...
{
	/// <summary>
	///     This component will update a <b>UI.Dropdown</b> component with localized text, or use a fallback if none is
	///     found.
	/// </summary>
	[ExecuteInEditMode]
	...
	public class LeanLocalizedDropdown : MonoBehaviour, ILocalizationHandler
	{
		...
		public void UpdateLocalization()
		{
			...
			List<Dropdown.OptionData> dOptions = dropdown.options;
