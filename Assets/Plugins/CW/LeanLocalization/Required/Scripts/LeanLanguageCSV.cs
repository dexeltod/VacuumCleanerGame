...
namespace Lean.Localization
{
    ...
    public class LeanLanguageCSV : LeanSource
    {
        ...
        private void LoadLegacy()
        {
            ...
            var lines = Source.text.Split(newlineCharacters, StringSplitOptions.RemoveEmptyEntries);
        ...
        protected override void OnInspector()
        {
            ...
            switch (tgt.Format)
            {
                case LeanLanguageCSV.FormatType.Legacy:
                    EditorGUILayout.TextArea("Hello = こんにちは // Comment\nCollectItem = アイテム \\n 集めました // Comment here",
                        GUILayout.Height(50));
                    break;
                case LeanLanguageCSV.FormatType.Comma:
                    EditorGUILayout.TextArea("Hello,こんにちは\nCollectItem,\"アイテム\n集めました\"");
                    break;
