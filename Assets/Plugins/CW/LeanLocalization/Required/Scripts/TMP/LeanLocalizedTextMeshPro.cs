...
{
	/// <summary>
	///     This component will update a TMPro.TextMeshPro component with localized text, or use a fallback if none is
	///     found.
	/// </summary>
	[ExecuteInEditMode]
	...
	[AddComponentMenu(
		LeanLocalization.ComponentPathPrefix + "Localized TextMeshPro"
	)]
