...
namespace Plugins.CW.LeanCommon.Extras.Scripts
{
	...
	[HelpURL(Required.Scripts.LeanCommon.HelpUrlPrefix + "LeanSpawn")]
	[AddComponentMenu(Required.Scripts.LeanCommon.ComponentPathPrefix + "Spawn")]
	...
	[CustomEditor(typeof(LeanSpawn))]
	public class LeanSpawn_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			LeanSpawn tgt; LeanSpawn[] tgts; GetTargets(out tgt, out tgts);
