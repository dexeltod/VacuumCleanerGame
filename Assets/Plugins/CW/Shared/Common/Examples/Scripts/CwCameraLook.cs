...
namespace Plugins.CW.Shared.Common.Examples.Scripts
{
	...
	[HelpURL(CwShared.HelpUrlPrefix + "CwCameraLook")] [AddComponentMenu(CwShared.ComponentMenuPrefix + "Camera Look")]
	public class CwCameraLook : MonoBehaviour
	{
		...
		[SerializeField] private CwInputManager.Axis rollControls = new CwInputManager.Axis(
			2,
			true,
		...
		[System.NonSerialized] private Quaternion remainingDelta = Quaternion.identity;
...
#if UNITY_EDITOR
	[CanEditMultipleObjects] [CustomEditor(typeof(CwCameraLook))]
