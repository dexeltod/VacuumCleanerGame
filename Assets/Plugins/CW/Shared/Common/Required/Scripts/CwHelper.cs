...
namespace CW.Common
{
    public static partial class CwHelper
    {
            ...
            Quaternion localRotation, Vector3 localScale, string recordUndo = null)
        {
            ...
            if (recordUndo != null)
            {
                Undo.RegisterCreatedObjectUndo(gameObject, recordUndo);
            }
#endif
        ...
        public static float DampenFactor(float speed, float elapsed)
        {
            ...
            return 1.0f - Mathf.Pow((float)Math.E, -speed * elapsed);
        }
...
namespace CW.Common
{
    public static partial class CwHelper
    {
        ...
        public static void DrawShapeOutline(Texture shapeTexture, int shapeChannel, Matrix4x4 shapeMatrix, Rect rect,
            Color color)
        {
            DrawShapeOutline(shapeTexture, shapeChannel, shapeMatrix,
                new Vector4(rect.xMin, rect.yMin, rect.xMax, rect.yMax), color);
        }
