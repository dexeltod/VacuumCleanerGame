...
namespace SerializeInterfaces.Editor
{
    internal static class InterfaceReferenceUtility
    {
            ...
            InterfaceObjectArguments args)
        {
            ...
            DrawInterfaceNameLabel(position, prevValue == null || isHovering ? $"({args.InterfaceType.Name})" : "*",
                controlID);
        ...
        private static void DrawInterfaceNameLabel(Rect position, string displayString, int controlID)
        {
            if (Event.current.type == EventType.Repaint)
            {
                ...
                _normalInterfaceLabelStyle.Draw(interfaceLabelPosition, EditorGUIUtility.TrTextContent(displayString),
                    controlID, DragAndDrop.activeControlID == controlID, false);
            }
        }
        ...
        private static bool IsAssignedAndHasWrongInterface(Object obj, InterfaceObjectArguments args) =>
            obj != null && !args.InterfaceType.IsAssignableFrom(obj.GetType());
