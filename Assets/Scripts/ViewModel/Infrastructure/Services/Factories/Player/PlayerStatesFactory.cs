...
using Model.SceneEntity.PlayerStates;
using UnityEngine;
...
namespace ViewModel.Infrastructure.Services.Factories.Player
{
	public class PlayerStatesFactory
	{
		...
		{
			_stateService.Register(new IdleState(_inputService, _animator, _animationHasher, _animatorFacade, new IStateTransition[]{}));
		}
	}
}