...
namespace Sources.Controllers
{
	public class ResourcesProgressPresenter : Presenter, IResourcesProgressPresenter
	{
		...
		public ResourcesProgressPresenter(IGameplayInterfaceView gameplayInterfaceView,
		...
		private void SetMoneyTextView() =>
			_gameplayInterfacePresenter.SetCashScore(_resourceReadOnly.SoftCurrency.Value);

		private void SetView()
		{
			_gameplayInterfacePresenter.SetTotalResourceScore(_resourceReadOnly.TotalAmount.Value);
			_gameplayInterfacePresenter.SetCashScore(_resourceReadOnly.CashScore.Value);
