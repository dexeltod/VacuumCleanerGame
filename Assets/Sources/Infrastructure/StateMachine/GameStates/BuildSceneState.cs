...
namespace Sources.Infrastructure.StateMachine.GameStates
{
    public sealed class BuildSceneState : IBuildSceneState
    {
        ...
        )
        {
            ...
            _upgradeWindowViewFactory = upgradeWindowViewFactory ?? throw new ArgumentNullException(nameof(upgradeWindowViewFactory));
            ...
            _resourcePathNameConfigProvider =
                resourcePathNameConfigProvider ?? throw new ArgumentNullException(nameof(resourcePathNameConfigProvider));

            _coroutineRunnerProvider = coroutineRunnerProvider ?? throw new ArgumentNullException(nameof(coroutineRunnerProvider));

            _sandCarContainerViewProvider =
                sandCarContainerViewProvider ?? throw new ArgumentNullException(nameof(sandCarContainerViewProvider));
            ...
            _sandParticleSystemProvider = sandParticleSystemProvider ?? throw new ArgumentNullException(nameof(sandParticleSystemProvider));
            ...
            _gameMenuPresenterProvider = gameMenuPresenterProvider ?? throw new ArgumentNullException(nameof(gameMenuPresenterProvider));

            _gameStateChangerProvider = gameStateChangerProvider ?? throw new ArgumentNullException(nameof(gameStateChangerProvider));
        ...
        {
            _sandParticleSystemProvider.Register<ISandParticleSystem>(playerGameObject.GetComponentInChildren<ISandParticleSystem>());
